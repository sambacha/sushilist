...
var CONTRACT_MAP_OUTPUT_PATH = /*#__PURE__*/resolve( /*#__PURE__*/tmpdir(), 'contract-metadata');
var ETHEREUM_LISTS_REPO = 'ethereum-lists/tokens/tokens/eth';
var ETHEREUM_LISTS_OUTPUT_PATH = /*#__PURE__*/resolve( /*#__PURE__*/tmpdir(), 'ethereum-lists/tokens');
/**
...
var TokenListEnumSchema = /*#__PURE__*/enum$1(['coingecko']);
/**
...
var TokenExtensionsSchema = /*#__PURE__*/object({
  ...
  isChefCurated: /*#__PURE__*/boolean().optional(),
    ...
    return runtime_1.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return promises.readdir(ETHEREUM_LISTS_OUTPUT_PATH);
              ...
              var _ref2 = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(tokens, file) {
                ...
                return runtime_1.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        jsonFile = resolve(ETHEREUM_LISTS_OUTPUT_PATH, file);
                        _context.next = 3;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            jsonFile = resolve(process.cwd(), 'chef.json');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            jsonFile = resolve(CONTRACT_MAP_OUTPUT_PATH, 'contract-map.json');
            _context.next = 5;
            return parseJsonFile(jsonFile);
...
var SVG_ORIGINALS_OUTPUT_PATH = /*#__PURE__*/resolve( /*#__PURE__*/tmpdir(), SVG_ORIGINALS_REPO);
var SVG_OVERRIDES_REPO = 'mikedemarais/react-coin-icon/assets/overrides';
var SVG_OVERRIDES_OUTPUT_PATH = /*#__PURE__*/resolve( /*#__PURE__*/tmpdir(), SVG_OVERRIDES_REPO);
    ...
    return runtime_1.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            // load svg manifest JSON file from directory
            jsonFile = resolve(SVG_ORIGINALS_OUTPUT_PATH, 'manifest.json');
    ...
    return runtime_1.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            _context3.next = 4;
            return promises.readdir(SVG_OVERRIDES_OUTPUT_PATH);
              ...
              var _ref = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(svgTokens, file) {
                ...
                return runtime_1.wrap(function _callee2$(_context2) {
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        svgPath = resolve(SVG_OVERRIDES_OUTPUT_PATH, file);
                        _context2.next = 3;
                        return promises.readFile(svgPath, 'utf8');
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 18:
          ...
          allKnownTokenAddresses = uniq(compact([].concat(sources["default"].map(Object.keys).flat(), sources.preferred.map(Object.keys).flat())).map(getAddress));
          _context.next = 25;
        ...
        case 25:
          ...
          return writeToDisk({
            ...
            keywords: ['sushiswap'],
            tokens: tokens
          }, resolve(process.cwd(), './output'), 'sushiswap-token-list.json');
...
export { constants as Types };
//# sourceMappingURL=sushiswap-token-list.esm.js.map
